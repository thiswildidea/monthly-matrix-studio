...
rem ============================================================
rem  Monthly Matrix Studio  launcher
rem
...
set "APPDIR=%~dp0"
set "APPFILE=%APPDIR%monthly_matrix_studio.html"
if not exist "%APPFILE%" (
  echo [ERROR] monthly_matrix_studio.html not found next to this launcher.
  echo         Keep both files in the same folder.
  pause
  exit /b 1
)

set "PROFILE=%LOCALAPPDATA%\MonthlyMatrixStudio\profile"
set "OUTDIR=%USERPROFILE%\Desktop\monthly-matrix-videos"
